...
import frameImage from '../assets/cross.jpeg'
    ...
    return (
        <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
            ...
            <div className='relative w-11/12 max-w-[450px]'>
                <img src={frameImage} alt="pattern" width={650} height={50} loading='lazy'/>

                <img src={image} alt="students" width={650} loading='lazy border-[2px]'
